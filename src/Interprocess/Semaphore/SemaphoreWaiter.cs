...
namespace Cloudtoid.Interprocess.Semaphore
{
    internal sealed class SemaphoreWaiter : IInterprocessSemaphoreWaiter
    {
        ...
        {
            watcher = new FileSystemWatcher(identifier.Path, identifier.Name + "*" + Constants.UnixDomainSocketFileExtension);
        ...
        private void ClientsLoop()
        {
            ...
            var fileSearchPattern = identifier.Name + "*" + Constants.UnixDomainSocketFileExtension;
